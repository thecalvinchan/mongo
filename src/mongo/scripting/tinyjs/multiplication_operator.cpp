...
MultiplicationOperator::MultiplicationOperator() : BinaryOperator(TokenType::kMultiply) {}

const Value MultiplicationOperator::evaluate(Scope* scope, Value& returnValue) const {
